      ...
      <div className="container mx-auto px-6 lg:px-8 flex flex-col lg:flex-row items-center gap-12 lg:gap-20 relative z-10">
        ...
        <div className="flex-1 text-center lg:text-left" data-aos="fade-right">
          ...
          <p className="text-gray-500 text-base lg:text-lg leading-relaxed mb-8 max-w-lg mx-auto lg:mx-0">
            Comprehensive digital solutions like POS, HRM, and LMS — tailored to
            optimize your operations and drive growth in the digital age.
          </p>
          ...
          <p className="text-xs text-gray-400 mt-6">
            Trusted by{" "}
            <span className="text-gray-600 font-medium">50+ businesses</span>{" "}
            across Bangladesh
          </p>
        </div>
