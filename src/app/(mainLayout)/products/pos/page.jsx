...
import { IoCheckmark, IoCart, IoTrendingUp, IoGlobe } from "react-icons/io5";
...
export default function EcommercePage() {
    ...
    const showcaseImages = [
        "https://i.ibb.co.com/xqSrt2bj/establish-button-hierarchy.png",
        "https://i.ibb.co.com/5hMRsXF7/134ec1184648067-66e0d877d0335.png",
        "https://i.ibb.co.com/DgRmx2Jx/106a5c243434229-Y3-Jvc-Cwx-Njc2-LDEz-MTEs-MTQ5-LDQx.jpg",
    ];
            ...
            <section className="py-20 md:py-24 border-b border-gray-100">
                <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">
                    ...
                    <motion.div initial="hidden" animate="visible" variants={fade} transition={{ delay: 0.2 }} className="w-full h-[400px] bg-gray-50 border border-gray-200 rounded-xl relative overflow-hidden">
                        <Image src={"https://i.ibb.co.com/ds4X5KMW/POS-System-in-Australia-1.webp"} alt="E-commerce UI" fill className="object-contain p-4" />
                    </motion.div>
                </div>
            </section>

            {/* Store Showcase Carousel (Swiper) */}
                        ...
                        >
                            {showcaseImages.map((src, index) => (
                                <SwiperSlide key={index}>
                                    <div className="relative h-[250px] bg-gray-50 border border-gray-200 rounded-xl overflow-hidden">
                                        <Image src={src} alt={`Store ${index + 1}`} fill className="object-cover" />
                                    </div>
                                </SwiperSlide>
                            ))}
                        </Swiper>
